...
*/
$config['tables']['users']           = 'ns_users';
$config['tables']['groups']          = 'ns_groups';
$config['tables']['users_groups']    = 'ns_users_groups';
$config['tables']['login_attempts']  = 'ns_login_attempts';
 ...
 */
$config['site_title']                 = "NutriSurvey";       		// 	Site Title, example.com
$config['admin_email']                = "webjob@comadreja.cl"; 	// 	Admin Email, admin@example.com
$config['default_group']              = 'Encuestador';          // 	Default group, use name
